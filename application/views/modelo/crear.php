                ...
                <form role="form" method="post" action="<?php echo base_url('index.php/modelo_controller/request'); ?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo set_value('nombre'); ?>" placeholder="Introduzca el nombre del modelo">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="marca" id="marca">
                                ...
                                <option value="<?php echo $marca->id; ?>" <?php echo set_select('marca', $marca->id); ?> >
